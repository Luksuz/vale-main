            ...
            <div className="row justify-content-center align-items-center">
              <div className="col-12 p-3">
                <p>
                  ...
                  self-taught full-stack developer with a passion for coding and
                  problem-solving. I recently completed a Python developer
                  qualification course at Algebra University, where I honed my
                  skills and knowledge in programming. One of my proudest
                  achievements is the creation of an
                  <a
                    style={{ textDecoration: "none", color: "#4477CE" }}
                    href="https://aistories.netlify.app"
                    target="_blank"
                  >
                    {" "}
                    AI stories generator app
                  </a>
                  , which includes captivating images to bring stories to life.
                  Alongside this major project, I've worked on various mini
                  projects that showcase my versatility and creativity.
                </p>
              </div>
            </div>
          ...
          <div className="container mt-5">
            <div className="row d-flex">
              ...
              <div className="col-12 col-lg-7">
                ...
                <p className="pt-4">
                  ...
                  a determination to overcome challenges. While some may
                  associate hard childhood stories with building strong-minded
                  individuals, my experience was different. Despite growing up
                  without a father for almost half of my childhood, I don't
                  consider myself part of that narrative. Instead, I believe
                  that every life journey has its unique lessons to offer.
                  Growing up in Croatia instilled in me a deep appreciation for
                  my roots and a sense of community. The vibrant culture and
                  rich history of my homeland continue to inspire me as I
                  venture into the world. Though I may have longed for a more
                  arduous childhood to foster an even greater strength of
                  character, I am grateful for the experiences that have shaped
                  who I am today. One figure who has consistently motivated me
                  is Elon Musk, an entrepreneur and visionary whose relentless
                  pursuit of innovation and passion for creating a better future
                  resonate deeply with me. While I don't believe that a role
                  model is necessary for greatness, Elon's inspiring journey has
                  left a lasting impression on my aspirations. In this section,
                  you'll uncover the foundations of my life in Croatia, the
                  lessons learned from challenges faced, and the influence of
                  remarkable individuals like Elon Musk on my drive to
                  accomplish something meaningful and impactful. Join me as I
                  share the story of my early years and the values that continue
                  to shape my path forward.
                </p>
              </div>
            </div>
            <hr></hr>
            <div className="row">
              <div className="col-12">
                ...
                <p className="pt-4">
                  ...
                  school, I began working at Kostwein Machinenbau for 6 years,
                  where I honed my skills in the manufacturing industry.
                  However, it was during this time that a pivotal moment
                  occurred—a moment that would change the course of my life. A
                  spark lit, and I realized my passion for technology and
                  programming, particularly Python. Motivated by this newfound
                  interest, I decided to take action and pursue a career in the
                  tech world. I enrolled in a Python developer course at Algebra
                  University, investing six months of dedicated effort to earn
                  my degree. Encouraged by this early success, I resolved to
                  expand my skill set further. My thirst for knowledge led me to
                  explore a diverse array of technologies that could bolster my
                  expertise and enhance my employability. This journey has not
                  only shaped my professional path but also solidified my belief
                  that passion, resilience, and a commitment to self-improvement
                  can lead to remarkable achievements. In this section, I invite
                  you to delve into my professional evolution, from the early
            ...
            <div className="row">
              <div className="col-12 col-lg-5">
                ...
                <p className="pt-4">
                  In both my personal and professional life, I adhere to core
                  values that shape my journey and future vision. My values
                  include having a clear and ambitious vision, which serves as a
                  compass to guide me; discipline, which ensures consistency and
                  progress; and continuous learning, which fosters adaptability
                  and innovation. Family support also plays a vital role,
                  providing emotional strength and encouragement. My future
                  vision is centered on contributing to humanity through
                  technology research, particularly in artificial intelligence
                  (AI). I am passionate about exploring AI's potential to solve
                  real-world problems and improve lives. My aspiration is to be
                  a catalyst for positive change, creating innovative solutions
                  that benefit society and foster a brighter future.{" "}
                </p>
              </div>
          ...
          <div className="col-12">
            ...
            <div className="row">
              <div className="col-12">
                ...
                <p>
                  You somehow dont have contacts on your phone? Thats where i
                  got you covered! Enjoy your own simple contacts app!
                </p>
            ...
            <div className="row d-flex justify-content-center align-items-center">
              <div className="col-10 col-lg-8 mt-3">
                ...
                <p>
                  ...
                  autobiography, intending to share intriguing chapters of my
                  life's journey with you. While this project is still a work in
                  progress, I encourage you to explore my blog page, where I
                  regularly share compelling thoughts and noteworthy events on a
                  weekly basis.
                </p>
